...
public class ProfitableOMP extends CodeGenPass {
    ...
    */
    public ProfitableOMP(Program program) {
        ...
        if (Driver.getOptionValue("profitable-omp") == null) {
        	PrintTools.printlnStatus("[ProfitableOMP] turning on required pass profitable-omp",0);
    ...
    public ProfitableOMP(Program program, int ho) {
    	super(program);
    }
    ...
    */
    public Expression countWorkLoad(Statement stmt) {
